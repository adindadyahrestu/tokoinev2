        ...
        <div class="container">
            ...
            <div class="card box">
                <div class="card-body">
                    ...
                    <p>anda Mempunyai (0) items didalam keranjang belanja</p>
                    <?php else :?>
                    <?php 
                    $items = 0;
                    ...
                    ?>
                    <p>anda Mempunyai (<?php echo $items; ?>) items didalam keranjang belanja</p>
                    <?php endif ;?>
                    ...
                    <table class="table table-hover table-striped">
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="hapus_keranjang.php?idproduk=<?php echo $pecah['id_produk']; ?>" class="btn btn-danger btn-sm">Hapus
