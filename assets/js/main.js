...
function getPageList(totalPage, page, maxLength){
    ...
    if(page <= maxLength - sideWidth - 1 - rightWidth){
        return rage(1, maxLength - sideWidth -1).concat(0, rage(totalPage - sideWidth + 1,totalPage));
    }

    if(page >= totalPage - sideWidth - 1 - rightWidth){
        return rage(1, sideWidth).concat(0, rage(totalPage - sideWidth - 1 - rightWidth - leftWidth,totalPage));
    }
...
$(function(){
    ...
    var limitPerPage = 6; //jumlah produk didalam halaman produk
